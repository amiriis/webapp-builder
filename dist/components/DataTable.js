...
function DataTable(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_materialReactTable.default, _extends({
    ...
    renderTopToolbarCustomActions: _ref => {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.enableCustomToolbar /* send condition */ ? /*#__PURE__*/_react.default.createElement(props.CustomToolbar, {
        mutate: mutate
      }) /* send component */ : /*#__PURE__*/_react.default.createElement("span", null));
    },
    renderBottomToolbarCustomActions: _ref2 => {
      let {
        table
      } = _ref2;
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.enableLastUpdate /* send condition */ ? /*#__PURE__*/_react.default.createElement(_material.Typography, {
        sx: {
          color: "primary.main",
          alignSelf: "center",
          whiteSpace: "nowrap",
    ...
    renderRowActions: _ref3 => {
      ...
      return /*#__PURE__*/_react.default.createElement(props.TableRowAction, {
        mutate: mutate,
        row: row
      });
    }
